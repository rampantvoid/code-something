...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      ...
      // <div className="z-10 flex h-6 w-2 items-center justify-center rounded-sm border bg-secondary">
